...
public partial class PlayerCountScreen : UserControl
{
    public event EventHandler<int>? PlayerCountSelected;

    public PlayerCountScreen() => InitializeComponent();
    ...
    public void LoadAssets(GameInstallation installation)
    {
        ...
        if (result.IsSuccessful) StarsImage.Source = new Bitmap(result.ImagePath!);
    }
